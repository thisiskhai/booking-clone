    ...
    <div className="footer">
      <div className="fLists">
        ...
        <ul className="fList">
          ...
          <li className="fListItem">About Roccabooking.com</li>
          <li className="fListItem">Customer Service Help</li>
          <li className="fListItem">Partner help</li>
          <li className="fListItem">Careers</li>
          <li className="fListItem">Sustainability</li>
          <li className="fListItem">Press Center Safety Resource Center</li>
      ...
      <div className="fText">
        Copyright © 1996–2023 Roccabooking.com™. All rights reserved.
      </div>
    </div>
  );
};
